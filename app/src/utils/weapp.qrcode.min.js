...
!function (t, e) {
  ...
  function t(t) {
    this.mode = r.MODE_8BIT_BYTE, this.setData(t);
  }
  function e(t, e) {
  ...
  t.prototype = {
    ...
    write: function (t) {
      for (var e = 0; e < this.length; e++) t.put(this.charCodeAt(e), 8);
    }
  }, e.prototype = {
    addData: function (e) {
      var r = new t(e);
  ...
  return m.prototype = {
    ...
    t = t || {}, (t = Object.assign({
      ...
      for (var n = t._this ? uni.createCanvasContext && uni.createCanvasContext(t.canvasId, t._this) : uni.createCanvasContext && uni.createCanvasContext(t.canvasId), o = t.width / r.getModuleCount(), i = t.height / r.getModuleCount(), a = 0; a < r.getModuleCount(); a++) for (var s = 0; s < r.getModuleCount(); s++) {
